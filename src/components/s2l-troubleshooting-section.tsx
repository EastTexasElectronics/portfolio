        ...
        <div className="max-w-5xl mx-auto px-8">
            <Accordion type="single" collapsible>
                ...
                <AccordionItem value="item-4">
                    <AccordionTrigger>What is Prefix for?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-7">
                    <AccordionTrigger>What is viewBox for?</AccordionTrigger>
                    <AccordionContent>
