            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="flex space-x-4">
                <motion.div
                  ...
                  onClick={() => track('Button Pressed', { button: 'Download on Mac App Store', location: 'FTG Section 1' })}
                >
                ...
                <motion.div
                  whileHover={ButtonAnimation.hover}
                  whileTap={ButtonAnimation.tap}
                  onClick={() => track('Button Pressed', { button: 'View on GitHub', location: 'FTG Section 1' })}
                >
        ...
        <Section className="py-12 md:py-24 lg:py-32 bg-white/5 rounded-xl">
          <div className="container px-4 md:px-6 text-center">
            ...
            <motion.div
              whileHover={ButtonAnimation.hover}
              whileTap={ButtonAnimation.tap}
              onClick={() => track('Button Pressed', { button: 'Contribute on GitHub', location: 'FTG Section 4' })}
            >
              <Link href="https://github.com/yourusername/file-tree-generator" target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="bg-white text-black hover:bg-neutral-200">
                  <Github className="mr-2 h-5 w-5" />
