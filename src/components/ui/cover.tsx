...
interface BeamProps extends React.ComponentProps<typeof motion.svg> {
  className?: string;
  delay?: number;
  duration?: number;
  hovered: boolean;
...
export const Cover: React.FC<CoverProps> = ({ children, className }) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className={`relative hover:bg-neutral-900 group/cover inline-block bg-black-100 px-2 py-2 transition duration-200 rounded-sm ${className}`}
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
          ...
          >
            ...
            >
              <SparklesCore
                ...
                minSize={0.4}
                maxSize={1}
                particleDensity={300} // Reduced density for mobile
      ...
      <motion.span
        ...
        className={cn(
          `inline-block bg-gradient-to-r from-blue-600 via-purple-700 to-fuchsia-700 text-transparent bg-clip-text
